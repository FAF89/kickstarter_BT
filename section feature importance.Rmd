...
rm(bic,res,res2,fullBIC,lmFull,features,current,string,i,j,lmPart,partBIC, aic, fullAIC, lables, partAIC,LRT,statChi,statDev)
```
...
rm(bic,res,res2,res3,emptyBIC,lmEmpty,features,current,string,j,lmPart,partBIC, aic, emptyAIC, lables, partAIC,colors, perkFeatures, projectFeatures, userFeatures,LRT,statChi,statDev)
